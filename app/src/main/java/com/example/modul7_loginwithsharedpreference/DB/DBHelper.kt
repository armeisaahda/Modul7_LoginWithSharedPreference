...
//class DBHelper berfungsi untuk membuka dan menutup koneksi SQLite
class DBHelper(context: Context): SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    //email dijadikan sebagai primaryKey

    override fun onCreate(db: SQLiteDatabase?) {//onCreate dijalankan ketika aplikasi dibuka
        db?.execSQL(SQL_CREATE_USER)//digunakan untuk menjalankan query SQL yg sudah didefinisikan
                                    //dalam property SQL_CREATE_USER
    }
    ...
    //atau bisa dibilang untuk proses pendaftaran pengguna ke SQLite
    ...
    //fungsi untuk pengecekan apakah user sudah terdaftar atau belum
    @SuppressLint("Range")
